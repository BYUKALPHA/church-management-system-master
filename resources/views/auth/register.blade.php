...
@section('content')
    ...
    <div id="page-container" class="fade">
        ...
        <div class="register register-with-news-feed">
            <!-- begin news-feed -->
            <div class="news-feed">
                <div class="news-image" style="background-image: url(/backend/img/login-bg/login-bg-15.jpg)"></div>
                <div class="news-caption">
                    <h4 class="caption-title"><b>The Well of Divine </b> Ministry International</h4>
                    <p>
