...
var handleDashboardGritterNotification = function() {
	$(window).on('load', function() {
		setTimeout(function() {
			$.gritter.add({
				title: 'Welcome back!',
				text: ' ALPHA DOTCOM is an innovative and total ICT solutions provider offering value added services and products for both individuals and companies/organisations.',
